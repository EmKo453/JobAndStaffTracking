...
def calculate_total_FTE_hours(id, location, start, stop, current_time, break_time):
...
def calculate_no_of_employees_per_hour():
    ...
    for i in job:
        ...
        job_duration_hour = (int(str((stop_time - start_time))[0:1])) + 1
...
def update_metrics(n_intervals):
    ...
    for i in job_data:
        calculate_total_FTE_hours(i[0], setup.Location_name, i[1], i[2], current_time, i[7])
